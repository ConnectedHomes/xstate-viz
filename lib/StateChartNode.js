...
var StateChartNode = /** @class */ (function (_super) {
    ...
    StateChartNode.prototype.render = function () {
        ...
        return (React.createElement(StyledStateNode, { key: stateNode.id, "data-key": stateNode.key, "data-type": dataType, "data-active": isActive && stateNode.parent, "data-preview": isPreview && stateNode.parent, "data-open": this.state.toggled || undefined, ref: this.stateRef },
            React.createElement(StyledStateNodeState, { "data-id": stateNode.id, "data-type": dataType },
                isActive && (dataType === 'atomic' || dataType === 'final') && (React.createElement(StyledActiveAnim, { key: this.props.transitionCount, style: {
                        // @ts-ignore
                ...
                Object.keys(stateNode.states).length ? (React.createElement(StyledChildStates, null, Object.keys(stateNode.states || []).map(function (key) {
                    ...
                    return (React.createElement(StateChartNode, { stateNode: childStateNode, level: _this.props.level + 1, current: current, preview: preview, key: childStateNode.id, onEvent: onEvent, onPreEvent: onPreEvent, onExitPreEvent: onExitPreEvent, toggledStates: _this.props.toggledStates, onSelectServiceId: _this.props.onSelectServiceId, transitionCount: _this.props.transitionCount }));
                }))) : null,
            ...
            React.createElement(StyledStateNodeEvents, null, getEdges(stateNode, { depth: 0 }).map(function (edge) {
                ...
                return (React.createElement(StyledEvent, { style: {
                    ...
                    React.createElement(StyledEventButton, { onClick: function () {
                            ...
                            .delay, "data-builtin": isBuiltInEvent || undefined, "data-transient": isTransient || undefined, "data-id": serializeEdge(edge), title: ownEvent },
                        React.createElement("label", null, friendlyEventName(ownEvent)),
                    ...
                    !!(edge.transition.actions.length || edge.transition.cond) && (React.createElement(StyledStateNodeActions, null, edge.transition.actions.map(function (action, i) {
                        var actionString = action.type === actionTypes.assign
                            ? JSON.stringify(action.assignments)
                            : action.type;
                        return (React.createElement(StateChartAction, { action: action, "data-action-type": "do" }));
                    })))));
            }))));
    };
