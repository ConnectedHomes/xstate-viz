...
export var App = function (_a) {
    ...
    var currentMachine = machine ? machine : examples.basic;
    var _b = useMachine(appMachine), current = _b[0], send = _b[1], service = _b[2];
    var _c = useReducer(layoutReducer, query.layout || 'full'), layout = _c[0], dispatchLayout = _c[1];
    return (React.createElement(StyledApp, { "data-layout": layout },
        ...
        React.createElement(AppContext.Provider, { value: { state: current, send: send, service: service } },
            ...
            current.matches({ gist: 'fetching' }) ? (React.createElement(Loader, null)) : (React.createElement(React.Fragment, null,
                React.createElement(StateChart, { machine: currentMachine, onSave: function (code) {
