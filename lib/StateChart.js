...
export var StateChart = function (_a) {
    ...
    function renderView() {
        var view = allState.view, current = allState.current, code = allState.code, service = allState.service;
        switch (view) {
            case 'definition':
    ...
    return (React.createElement(StyledStateChart, { className: className, key: code, style: {
        ...
        React.createElement(StyledSidebar, null,
            React.createElement(StyledViewTabs, null, ['definition', 'state', 'events'].map(function (view) {
                return (React.createElement(StyledViewTab, { onClick: function () { return setState(__assign({}, allState, { view: view })); }, key: view, "data-active": allState.view === view || undefined }, view));
            })),
            renderView())));
};
