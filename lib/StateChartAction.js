...
export var StateChartAction = function (_a) {
    ...
    switch (action.type) {
        ...
        case actionTypes.invoke:
            return (React.createElement(StyledStateChartAction, __assign({}, dataAttrs), action.id));
        ...
        default:
            ...
            return (React.createElement(StyledStateChartAction, __assign({}, dataAttrs), action.type));
    }
};
